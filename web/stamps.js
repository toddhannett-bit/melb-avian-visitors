...
(function () {
  ...
  var GENUS_GROUP = {
    ...
    // ---- Australia (Melbourne). Where a bird's real family already has a
    // group it joins it; the rest are grouped the way a field guide shelves
    // them, lumping close relatives so the Family view is not a long run of
    // one-stamp sections. GENUS_LATIN below keeps each bird's printed family
    // true even where its group is a lump.
    Chenonetta:'Waterfowl', Tadorna:'Waterfowl',
    Fulica:'Waterfowl',                                    // a rail, shelved with the ducks it swims among
    Phaps:'Doves & Pigeons',
    Dacelo:'Kingfishers',
    Acridotheres:'Blackbirds & Orioles',                   // a starling, beside the Common Starling
    Vanellus:'Gulls',                                      // a plover, as upstream shelves Charadrius
    Threskiornis:'Herons',                                 // an ibis, with its long-legged neighbours
    Cacatua:'Parrots & Cockatoos', Eolophus:'Parrots & Cockatoos',
    Calyptorhynchus:'Parrots & Cockatoos', Alisterus:'Parrots & Cockatoos',
    Trichoglossus:'Parrots & Cockatoos', Glossopsitta:'Parrots & Cockatoos',
    Psephotus:'Parrots & Cockatoos',
    Manorina:'Honeyeaters', Anthochaera:'Honeyeaters', Caligavis:'Honeyeaters',
    Phylidonyris:'Honeyeaters', Ptilotula:'Honeyeaters',
    Gymnorhina:'Butcherbirds & Magpies', Cracticus:'Butcherbirds & Magpies',
    Strepera:'Butcherbirds & Magpies',
    Pardalotus:'Pardalotes & Thornbills', Acanthiza:'Pardalotes & Thornbills',
    Rhipidura:'Fantails & Monarchs', Grallina:'Fantails & Monarchs',
    Acrocephalus:'Reed Warblers & Silvereyes', Poodytes:'Reed Warblers & Silvereyes',
    Zosterops:'Reed Warblers & Silvereyes',
    Pachycephala:'Whistlers & Cuckooshrikes', Coracina:'Whistlers & Cuckooshrikes',
    Cacomantis:'Cuckoos'
  };

  /* Real family for genera that sit in a lumped group, so the stamp and the
     species card never print the wrong one - a Magpie-lark is a monarch, not
     a fantail, and an ibis is not a heron. Only genera whose family differs
     from their group's GROUP_LATIN need an entry. */
  var GENUS_LATIN = {
    Fulica:'Rallidae', Acridotheres:'Sturnidae', Vanellus:'Charadriidae',
    Threskiornis:'Threskiornithidae',
    Cacatua:'Cacatuidae', Eolophus:'Cacatuidae', Calyptorhynchus:'Cacatuidae',
    Acanthiza:'Acanthizidae', Grallina:'Monarchidae',
    Poodytes:'Locustellidae', Zosterops:'Zosteropidae',
    Coracina:'Campephagidae',
    // Upstream's groups printed these two wrong: a starling is not a New World
    // blackbird, and the House Sparrow is an Old World sparrow, not an
    // American one.
    Sturnus:'Sturnidae', Passer:'Passeridae'
  };
  ...
  var GROUP_LATIN = {
    ...
    'Parrots & Cockatoos':'Psittaculidae', 'Honeyeaters':'Meliphagidae',
    'Butcherbirds & Magpies':'Artamidae', 'Pardalotes & Thornbills':'Pardalotidae',
    'Fantails & Monarchs':'Rhipiduridae', 'Reed Warblers & Silvereyes':'Acrocephalidae',
    'Whistlers & Cuckooshrikes':'Pachycephalidae', 'Cuckoos':'Cuculidae'
  };
  ...
  function latinOf(sci) {
    var genus = String(sci || '').split(' ')[0];
    if (GENUS_LATIN[genus]) return GENUS_LATIN[genus];
    var g = groupFor(sci);
